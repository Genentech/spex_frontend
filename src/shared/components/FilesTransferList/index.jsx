 ...
 */
const FilesTransferList = styled((props) => {
  const {
    className,
    options,
    input,
  ...
  const value = input?.value || props.file_names;
...
FilesTransferList.defaultProps = {
  className: '',
  options: [],
  input: {},
  value: [],
...
export default FilesTransferList;
